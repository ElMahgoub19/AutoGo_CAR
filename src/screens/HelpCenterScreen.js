      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: spacing.base, paddingBottom: 40 }}>
          ...
          {[
            ...
            >
              <View style={{
                ...
                <Ionicons name={action.icon} size={22} color={colors.accent.primary} />
              </View>
        ...
        {filteredData.map((category, catIdx) => (
          <Card key={catIdx} style={{ marginBottom: spacing.md }}>
            ...
            >
              <Ionicons
                name={expandedCategory === catIdx ? 'chevron-up' : 'chevron-down'}
                size={18}
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <Ionicons name={category.icon} size={18} color={colors.accent.primary} />
                </View>
              </View>
            </TouchableOpacity>
