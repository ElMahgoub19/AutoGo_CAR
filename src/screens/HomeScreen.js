...
const HomeScreen = ({ navigation }) => {
  ...
  const { activeCar, cars } = useSelector(state => state.garage);
          ...
          {services.map((service) => (
            ...
            >
              <View style={styles.serviceIcon}>
                <Ionicons name={service.icon} size={24} color={colors.accent.primary} />
              </View>
              ...
              <Card key={order.id} style={styles.orderCard} onPress={() => navigation.navigate('OrderStatus', { order })}>
                <View style={styles.orderRow}>
                  ...
                  <View style={styles.orderIcon}>
                    <Ionicons name={order.icon === 'truck' ? 'car' : 'construct'} size={22} color={colors.accent.primary} />
                  </View>
                </View>
              </Card>
            ))}
